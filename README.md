...
I've always been curious about what it takes to land a high-paying role in the data science field. I set out to explore the job market by analyzing what skills top employers request and how those skills connect to salary.
...
As someone passionate about data, I built this Excel-based project to uncover meaningful insights about the data science job market. Using a dataset of real-world job postings, I analyzed job titles, salaries, locations, and essential skills. By leveraging Excel features like Power Query, PivotTables, DAX, and charts, I discovered key correlations between multiple skills and higher salaries, particularly in Python, SQL, and cloud technologies.

I hope this project serves as a useful reference for anyone exploring what skills are needed to break into higher-paying roles in data.
